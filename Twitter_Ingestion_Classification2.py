...
#                print(ensemble_Ind)
                ...
                cursor.execute("INSERT INTO tweets (created_at, tweet_text, keywords_strings, language, place_country,place_name,place_type,hashtags,long,lat, Naive_Bayes_Ind, Random_Forest_Ind, SVM_Ind, ensemble_Ind ) VALUES (?, ?, ?,?,?,?,?,?,?,?,?,?,?,?)",
                    (created_at, tweet_text, keywords_strings, lang, place_country, place_name, place_type, hashtag_list, long, lat, Naive_Bayes_Ind, Random_Forest_Ind, SVM_Ind, ensemble_Ind))
